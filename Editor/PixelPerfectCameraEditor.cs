...
namespace UnityEditor.U2D
{
    ...
    class PixelPerfectCameraEditor : Editor
    {
        private class Style
        {
           ...
           public static string srpWarning = "Pixel Perfect Camera in the 2D Pixel Perfect package isn't compatible with Scriptable Render Pipeline.\nIf you are using the Universal Render Pipeline, you can upgrade this to the Pixel Perfect Camera component that ships with URP.\nUse Window > Rendering > Render Pipeline Converter";
